...
public interface IInitializer {
     ...
     */
    void initOnMainProcess(@NonNull Context context) throws Throwable;
     ...
     * @throws Throwable 可能會抛出異常
     */
    void initOnOtherProcess(@NonNull Context context, @NonNull int pid, @NonNull String processName) throws Throwable;
