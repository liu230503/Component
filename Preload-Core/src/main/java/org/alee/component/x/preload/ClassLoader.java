...
class ClassLoader {
    ...
    public static Set<String> getFileNameByPackageName(Context context, final String packageName) throws PackageManager.NameNotFoundException, IOException, InterruptedException {
        ...
        for (final String path : paths) {
            new Thread(() -> {
                ...
                try {
                    ...
                    Log.e(Constant.TAG, "Scan map file in dex files made error." + ignore);
                } finally {
                    if (null != dexfile) {
                        try {
                            dexfile.close();
        ...
        parserCtl.await();
        Log.i(Constant.TAG, "Filter " + classNames.size() + " classes by packageName <" + packageName + ">");
        return classNames;
    }
    ...
    private static boolean isVMMultiDexCapable() {
        ...
        Log.i(Constant.TAG, "VM with name 'Android'" + (isMultidexCapable ? " has multidex support" : " does not have multidex support"));
    ...
    private static List<String> tryLoadInstantRunDexFile(ApplicationInfo applicationInfo) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && null != applicationInfo.splitSourceDirs) {
            ...
            Log.i(Constant.TAG, "Found InstantRun support");
        } else {
            try {
                ...
                Log.e(Constant.TAG, "InstantRun support error, " + e.getMessage());
            }
        }
